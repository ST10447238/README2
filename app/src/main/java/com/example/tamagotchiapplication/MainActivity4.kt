...
class MainActivity4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnReturn2 = findViewById<Button>(R.id.btnReturn2)//(IIE,2024)
        btnReturn2.setOnClickListener{ //(IIE,2024)
            val intent4 = Intent(this,MainActivity2::class.java)//(see Five Minute How to move  from one activity to another activity-Brijesh Kumar Sharm,2021)
